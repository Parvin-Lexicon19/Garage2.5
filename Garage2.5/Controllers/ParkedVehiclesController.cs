...
namespace Garage2._5.Controllers
{
    public class ParkedVehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RegNo,Color,Brand,Model,NoOfWheels,MemberId")] ParkedVehicle parkedVehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RegNo,Color,Brand,Model,NoOfWheels,MemberId")] ParkedVehicle parkedVehicle)
        {
